...
public class AreaCalculatorApp {
	...
	public static void main(String[] args) {
		...
		while (choice.equalsIgnoreCase("Y")) {
			...
			String type = Console.getRequiredString("Calculate area of" + " circle, square, or rectangle? (c/s/r) ");
			Shape shape = null;
			...
			//The area of the Rectangle you entered is 300.00"
			String shapeType = shape.getClass().getName();
			double area = shape.getArea();
			System.out.println("The area of the "+shapeType+" y ou entered is "+area);
