...
public class CollectionDemoApp {
	...
	public static void main(String[] args) {
		...
		//p. 409
		Product p1 = new Product("java", "Murach's Java Programing", 59.50);
		Product p2 = new Product("andr", "Murach's Android Programing", 57.50);
		Product p3 = new Product("net", "Murach's .Net Programing", 58.50);
