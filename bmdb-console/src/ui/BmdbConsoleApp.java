...
public class BmdbConsoleApp {
	...
	public static void main(String[] args) throws IOException {
		...
		while (!command.equalsIgnoreCase("exit")) {
			...
			System.out.println("addact - add an actor");
			...
			command = Console.getRequiredString("Command: " /* validEntries */);
			switch (command) {
			case "show":
			...
			case "addact":
				...
				int birthDate = Console.getInt("birthDate: ", 0, Integer.MAX_VALUE);
