...
public class ProductApp {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"product1 = " + product1.getCode() + ", " + product1.getDescription() 
			+ ", " + product1.getPrice());
		...
		//System.out.println("Product desc ="+Product.getDescription)); <= cannot static call getter
		
		//create a vendor
		Vendor vendor1 = new Vendor();  //Java gives you a constructor by default
		//Java's default constructor goes away if you generate any other constructor
		
		String code = Console.getString("Product Code:  ");
		String desc = Console.getString("Product Description:  ");
